...
-- ⚠️ ADVERTENCIA: Este script reiniciará las tablas listadas abajo.
-- Úsalo para configurar inicialmente o resetear la base de datos.
...
-- =================================================================
-- 1. MÓDULO DE USUARIOS Y PERFILES
-- =================================================================
...
create table public.perfiles (
  ...
  plan text check (plan in ('básico', 'premium')),
...
create policy "Perfiles públicos visibles por todos" on public.perfiles for select using (true);
...
-- Catálogo Global de Ejercicios (Solo lectura para usuarios)
...
-- =================================================================
-- 4. MÓDULO DE GESTIÓN DE GIMNASIO (B2B)
-- =================================================================
...
create table public.miembros_gym (
  id bigint generated by default as identity primary key,
  gym_id uuid references public.perfiles(id) on delete cascade, -- El dueño del gimnasio
  nombre text not null,
  email text,
  plan text,
  estado text check (estado in ('Al día', 'Vencido')),
...
-- =================================================================
-- DATOS SEMILLA (MIGRACIÓN DE DATOS LOCALES)
-- =================================================================
...
('Curl de Bíceps', 'Ejercicio de aislamiento para bíceps.', 'https://images.pexels.com/photos/1431282/pexels-photo-1431282.jpeg?auto=compress&cs=tinysrgb&w=600', 'https://videos.pexels.com/video-files/4761426/4761426-sd_640_360_25fps.mp4', 'Principiante', 'FUERZA', 'Mancuernas', ARRAY['Bíceps', 'Brazos'], 5, true, ARRAY['Brazos extendidos', 'Flexiona codos', 'Baja controlado']),
('Remo con Barra', 'Ejercicio compuesto para espalda.', 'https://images.pexels.com/photos/949126/pexels-photo-949126.jpeg?auto=compress&cs=tinysrgb&w=600', 'https://videos.pexels.com/video-files/8558238/8558238-sd_640_360_25fps.mp4', 'Intermedio', 'FUERZA', 'Barra', ARRAY['Espalda', 'Bíceps'], 8, false, ARRAY['Inclina torso', 'Tira barra al pecho', 'Aprieta espalda']),
('Sentadilla con Barra', 'El rey de los ejercicios de piernas.', 'https://images.pexels.com/photos/116077/pexels-photo-116077.jpeg?auto=compress&cs=tinysrgb&w=600', 'https://videos.pexels.com/video-files/3209191/3209191-sd_640_360_25fps.mp4', 'Avanzado', 'FUERZA', 'Barra', ARRAY['Piernas', 'Glúteos'], 10, false, ARRAY['Barra en trapecios', 'Espalda recta', 'Baja profundo', 'Empuja con talones']),
...
('first_pr', 'Superando Límites', 'Rompe tu primer récord personal.', '🚀', 300),
('10k_volume', 'Levantador Novato', 'Levanta 10,000 kg en total.', '💪', 200),
...
('three_months', 'Consistencia de Élite', 'Entrena de forma consistente por 3 meses.', '💎', 3000);
...
('Diego V.', 'rompió su PR en Peso Muerto (140kg)', '2h', 'workout', 12),
('Sofia G.', 'subió a Nivel 5: "Atleta"', '4h', 'level_up', 24),
('Mateo H.', 'completó el reto "Semana de Fuego"', '5h', 'achievement', 8),
('Laura M.', 'finalizó clase de Yoga Flow', '6h', 'workout', 5);
...
VALUES
('Sesión de Entrenamiento Personalizado', 'Una sesión de 60 minutos uno a uno.', 'https://images.pexels.com/photos/3757942/pexels-photo-3757942.jpeg?auto=compress&cs=tinysrgb&w=600', 'https://videos.pexels.com/video-files/4761426/4761426-sd_640_360_25fps.mp4', 'Juan Valdez', 60, 50000, 'Gimnasio'),
('Asesoría Nutricional Fitness', 'Consulta de 45 minutos.', 'https://images.pexels.com/photos/1128678/pexels-photo-1128678.jpeg?auto=compress&cs=tinysrgb&w=600', 'https://videos.pexels.com/video-files/3195968/3195968-sd_640_360_25fps.mp4', 'Juan Valdez', 45, 40000, 'Virtual');
