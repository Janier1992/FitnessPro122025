...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service, onViewDetails, isCoachView = false }) => {
    ...
    return (
        ...
        >
            <button 
                onClick={() => !isCoachView && onViewDetails(service)} 
                disabled={isCoachView}
                className="flex flex-col flex-grow text-left focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 rounded-lg disabled:cursor-default group"
            >
