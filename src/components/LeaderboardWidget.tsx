...
export const LeaderboardWidget: React.FC<LeaderboardWidgetProps> = ({ data, currentUserId: _currentUserId }) => {
    return (
            ...
            <div className="space-y-2">
                {data.map((entry, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className={`w-8 h-8 flex items-center justify-center font-bold rounded-full mr-3 ${index === 0 ? 'bg-yellow-100 text-yellow-600' :
