        ...
        if (step === 1) return (
            <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {['Ganar Músculo', 'Perder Grasa', 'Mejorar Resistencia', 'Salud General'].map((goal) => (
                        <button key={goal} onClick={handleNext} className="p-4 border-2 border-slate-200 rounded-xl hover:border-brand-primary hover:bg-green-50 transition-all text-left group">
                            <span className="font-bold text-slate-700 group-hover:text-brand-primary">{goal}</span>
                        </button>
                    ))}
                </div>
            </div>
         ...
         if (step === 2) return (
            <div className="text-center animate-fade-in">
                ...
                <button onClick={onComplete} className="bg-brand-primary text-white font-bold py-3 px-8 rounded-lg hover:bg-brand-secondary shadow-lg">
                    Ir a mi Dashboard
                </button>
            </div>
        );
    ...
    const GymContent = () => {
        ...
        if (step === 2) return (
            <div className="text-center animate-fade-in">
                ...
                <button onClick={onComplete} className="bg-brand-dark text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 shadow-lg">
                    Ir al Panel
                </button>
            </div>
        );
        ...
        if (step === 0) return (
         ...
         if (step === 2) return (
            <div className="text-center animate-fade-in">
                ...
                <button onClick={onComplete} className="bg-purple-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-purple-700 shadow-lg">
                    Ver mi Agenda
                </button>
            </div>
        );
