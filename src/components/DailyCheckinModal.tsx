...
export const DailyCheckinModal: React.FC<DailyCheckinModalProps> = ({ userName, onComplete }) => {
                ...
                <div className="p-8 text-center">
                    ...
                    {step === 4 && (
                         <div className="animate-slide-up">
                            ...
                            <button onClick={handleFinish} className="w-full bg-brand-primary text-white font-bold py-3 rounded-xl hover:bg-brand-secondary transition-colors shadow-lg shadow-brand-primary/30">
