...
// Using reliable Google CodeSkulptor assets for demo purposes to ensure playback.
// Switched all to MP3 to ensure iOS/Safari compatibility.
const PLAYLISTS: Playlist[] = [
    {
        ...
        icon: '💪',
        // Reliable demo track (MP3)
        audioSrc: 'https://codeskulptor-demos.commondatastorage.googleapis.com/GalaxyInvaders/theme_01.mp3'
    },
    {
        id: '2',
        name: 'Cardio Rhythm ⚡',
        ...
        icon: '🏃',
        // Reliable demo track (MP3) - Racing style music suitable for cardio
        audioSrc: 'https://commondatastorage.googleapis.com/codeskulptor-demos/riceracer_assets/music/race1.mp3'
    },
    {
        id: '3',
        name: 'Zen Focus 🧘',
        ...
        icon: '🍃',
        // Reliable demo track (MP3)
        audioSrc: 'https://codeskulptor-demos.commondatastorage.googleapis.com/pang/paza-moduless.mp3'
    }
];
